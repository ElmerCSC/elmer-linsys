...
--cpu_solver_pcg (default "pcg + ams + relax 2") and --cpu_solver_cg (default "cg + none").
...
cpu_solver_pcg = "pcg + ams + relax 2"
...
def main():
    ...
    ax.plot(pcg_partitions, pcg_times, marker='o', color='tab:blue', label="CPU: hypre pcg + ams + relax 2")
