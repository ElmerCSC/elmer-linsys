...
####
# Script to run EndWindings problem with Hypre solvers on GPUs (CUDA)

# Change the problem parameter
# Change the container_path to the container where hypre was built with cuda.
####
set -euo pipefail
